import{s,i as n,e as a}from"./icons-e4221401.js";const c=(e,i)=>{const r=e.map(t=>`<h2 class="ingridient-title" data-id-igridient =${t._id}>${t.title}</h2>
  ...
  </div>`).join("");i.innerHTML=r};function l(e){return e||"Unfortunately we don't have it yet"}const d=document.querySelector(".container-non-photos"),o=document.querySelector(".gallery-header"),u=document.querySelector(".description-no-coctails"),p=document.querySelector("span-no-coctails");document.querySelector(".gallery-list");n.length===0||!n?(console.log(n),a(d,o,u,p)):(console.log(n),o.textContent="Favorite ingredients",n.forEach(e=>{c(e),console.log(e)}));
