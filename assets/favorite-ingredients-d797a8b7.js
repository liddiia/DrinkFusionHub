import{b as a,h as f,i as p,j as m,s as u,k as s,l as b,n as y,o as h}from"./icons-944421b6.js";const v=n=>{a.classList.toggle("is-open"),m(n)};function k(n,o){const c=i=>{const{target:t}=i;console.log(t);const l=t.dataset.idIgridient;console.log(l),t.classList.contains("cocktail-learn-more-btn")&&(setTimeout(a.classList.toggle("is-open"),500),o(l),f(i));const d=g=>{g.key==="Escape"&&(v(g),document.removeEventListener("keydown",d))};document.addEventListener("keydown",d)},e=i=>{const{target:t}=i;(t===p||t===a||t.classList.contains("ingridient-modal-back-btn"))&&v(t)};n.addEventListener("click",c),a.addEventListener("click",e)}const I=(n,o)=>{const c=n.map(e=>` <li class= "fav-ingr-item>
