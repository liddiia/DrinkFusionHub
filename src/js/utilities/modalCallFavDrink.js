...
import { renderFavPagination } from './favorites-pagination';
import { modal, modalCloseBtn } from './refs'
import { showIngridient } from '../modal-igridients';
import { COCTAILMODAL_ID, favorites } from './local-storage';
...
export function modalCallFavDrink(el, renderFunc) {
  const openModal = (e) => {
